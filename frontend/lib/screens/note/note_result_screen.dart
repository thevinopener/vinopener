                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TasteParam(label: '당도', value: noteDetail.sweetness),
                                SizedBox(height: 10),
                                TasteParam(label: '산도', value: noteDetail.acidity),
                                SizedBox(height: 10),
                                TasteParam(label: '바디', value: noteDetail.intensity),
                                SizedBox(height: 10),
                                TasteParam(label: '타닌', value: noteDetail.tannin),
                                SizedBox(height: 10),
                                TasteParam(label: '알코올', value: noteDetail.alcohol),
                                SizedBox(height: 30),
                                Row(
                                  children: [
                                    Text(
