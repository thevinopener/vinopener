                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TasteParam(
                              label: '당도',
                              value: noteDetailWineReview.sweetness),
                          SizedBox(
                            height: 10,
                          ),
                          TasteParam(
                          ...
                          TasteParam(
                              label: '바디',
                              value: noteDetailWineReview.intensity),
                          SizedBox(
                            height: 10,
                          ),
                          TasteParam(
                          ...
                          TasteParam(
                              label: '알코올',
                              value: noteDetailWineReview.alcohol),
                          SizedBox(
                            height: 30,
                          ),
                          Row(
                          ...
                          Container(
                            ...
                            child: Text(
                              noteDetailWineReview.opinion,
                              style:
                                  TextStyle(fontSize: AppFontSizes.mediumSmall),
                            ),
                          ),
                          SizedBox(
                            height: 40,
