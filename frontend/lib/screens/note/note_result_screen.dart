  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<NoteDetailModel>(
                          ...
                          children: [
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return WineFlavour(
                                  flavour: Flavour(
                                      id: flavour.id, taste: flavour.taste),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TasteParam(
                                      label: '당도',
                                      value: noteDetail.sweetness,
                                      readOnly: true),
                                  SizedBox(height: 10),
                                  TasteParam(
                                      label: '산도',
                                      value: noteDetail.acidity,
                                      readOnly: true),
                                  SizedBox(height: 10),
                                  TasteParam(
                                      label: '바디',
                                      value: noteDetail.intensity,
                                      readOnly: true),
                                  SizedBox(height: 10),
                                  TasteParam(
                                      label: '타닌',
                                      value: noteDetail.tannin,
                                      readOnly: true),
                                  SizedBox(height: 10),
                                  TasteParam(
                                      label: '알코올',
                                      value: noteDetail.alcohol,
                                      readOnly: true),
                                  SizedBox(height: 30),
                                  Row(
                                    children: [
