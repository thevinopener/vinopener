                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      SurveyRangeSlider(currentRangeValues: RangeValues(25.0, 75.0), onRangeSelected: _updateAlcoholRange),
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text('단맛',
                            style: TextStyle(fontSize: AppFontSizes.large)),
                      ),
                      SurveySlider(currentSliderValue: 50.0, onChanged: _updateSweetness),
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text('신맛',
                            style: TextStyle(fontSize: AppFontSizes.large)),
                      ),
                      SurveySlider(currentSliderValue: 50.0, onChanged: _updateAcidity),
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text('떫기',
                            style: TextStyle(fontSize: AppFontSizes.large)),
                      ),
                      SurveySlider(currentSliderValue: 50.0, onChanged: _updateBitterness),
                    ],
                  ),
                )),
            Container(
