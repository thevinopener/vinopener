...
class SearchSecondCameraScreen extends StatefulWidget {
  final CameraDescription camera;

  const SearchSecondCameraScreen({super.key, required this.camera});

  @override
  State<SearchSecondCameraScreen> createState() => _SearchSecondCameraScreenState();
}

class _SearchSecondCameraScreenState extends State<SearchSecondCameraScreen> {
